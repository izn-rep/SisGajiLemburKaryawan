...
public static Connection bukakoneksi()throws SQLException {
        ...
        String loginUrl = "jdbc:postgresql://127.0.0.1:5432/gaji_lembur_karyawan";

        try
           {
              return bukakoneksi("org.postgresql.Driver", "jdbc:postgresql://127.0.0.1:5432/gaji_lembur_karyawan", "postgres", "admin");
            }
